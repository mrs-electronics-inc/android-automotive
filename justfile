...
flash-android-automotive: verify-deploy-artifacts
    cd {{ local_images_dir }} && sudo ./uuu_imx_android_flash.sh -f imx8qm -i -d md -D {{ local_images_dir }}
    cd {{ local_images_dir }} && sudo ./fastboot_imx_flashall.sh -f imx8qm -e -d md -D {{ local_images_dir }}
